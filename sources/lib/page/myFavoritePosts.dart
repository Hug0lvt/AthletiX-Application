...
class MyFavoritePostsPage extends StatefulWidget {
  @override
  _MyFavoritePostsState createState() => _MyFavoritePostsState();
}

class _MyFavoritePostsState extends State<MyFavoritePostsPage> {
  ...
  Future<void> fetchVideos() async {
    try {
      List<Post> posts = await postsClientApi.getPostsLikedByUser(_profile!.id!.toString());
      setState(() {
        _posts = posts;
      });
    } catch (e) {

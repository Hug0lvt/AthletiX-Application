...
import 'package:AthletiX/page/myPosts.dart'; // Ensure this is the correct path to MyPostPage
  ...
  Widget _buildImage(double screenWidth, double screenHeight) {
    try {
      ...
      return Image.network(
        "https://via.placeholder.com/${screenWidth * 0.20}/3C383B/B66CFF?text=${_profile?.username?.substring(0, 1)}",
        fit: BoxFit.cover,
      );
    }
  }
